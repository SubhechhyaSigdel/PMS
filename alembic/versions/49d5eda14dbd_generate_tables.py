...
Revision ID: 49d5eda14dbd
Revises: 
Create Date: 2026-01-23 20:23:33.736216
...
def upgrade() -> None:
    ...
    sa.CheckConstraint('no_of_guests > 0', name='check_guest_count_positive'),
    sa.CheckConstraint('per_night_rate > 0', name='check_per_night_rate_positive'),
