...
Revision ID: 913d8f18e58a
Revises: 
Create Date: 2026-01-10 23:52:42.297421
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('RESERVED', 'CHECKED_IN', 'CHECKED_OUT','CANCELED', name='reservationstatus'), nullable=False),
